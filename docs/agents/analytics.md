...
- Purpose: Convert raw rows into PT-BR business narrative with intelligent data balancing.
- LLM-First Approach:
  - Intelligent decision making: complete data vs. analytical insights based on dataset size and query intent.
