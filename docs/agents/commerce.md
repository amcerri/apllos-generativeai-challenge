...
## Processor (`app/agents/commerce/processor.py`)
...
## LLM Extractor (`app/agents/commerce/extractor_llm.py`)
...
## Heuristic Extractor (`app/agents/commerce/extractor.py`)
...
## Summarizer (`app/agents/commerce/summarizer.py`)
